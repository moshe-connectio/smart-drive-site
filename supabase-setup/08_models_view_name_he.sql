-- ============================================================================
-- Migration: Expose name_he on the models_with_manufacturer view
-- ----------------------------------------------------------------------------
-- The manufacturer model cards and the model page show the Hebrew model name
-- (new_vehicles_models.name_he) with a fallback to the English `name`.
-- The view didn't select name_he, so the UI always fell back to English.
-- This recreates the view to include mo.name_he.
--
...
SELECT
  mo.id, mo.name, mo.name_he, mo.slug, mo.image_url, mo.description,
...
GROUP BY mo.id, mo.name, mo.name_he, mo.slug, mo.image_url, mo.description,
         mo.body_type, mo.segment, mo.base_price,
