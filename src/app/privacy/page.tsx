          ...
          <Container>
            <div className="legal-doc">
              ...
              <p className="legal-note">
                מדיניות פרטיות זו נכתבה כתבנית כללית בהתאם לדין הישראלי. מומלץ להתאים אותה לפעילות
                העסקית בפועל (לרבות שימוש בכלי אנליטיקה, פיקסלים ודיוור) ולהיוועץ באיש מקצוע משפטי
                לפני פרסום סופי.
              </p>
            </div>
          </Container>
