...
const advantages: AdvantageItem[] = [
  {
    title: 'ליווי אישי',
    desc: 'מדברים איתכם בגובה העיניים, עונים על השאלות ועוזרים למצוא את הרכב שמתאים לכם.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: 'טרייד־אין',
    desc: 'יש לכם רכב בבית? בודקים אותו, מקזזים את השווי בעסקה ומטפלים בניירת במקום אחד.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: 'יודעים מה אתם קונים',
    desc: 'עוברים איתכם על הנתונים החשובים של הרכב, כדי שתדעו בדיוק מה מתאים לכם לפני שמחליטים.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: 'אפשר לבדוק עד 100% מימון',
    desc: 'רוצים לשמור את הכסף בצד? נבדוק עבורכם אפשרות למימון מלא, בכפוף לאישור הגוף המממן.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
