...
export function Footer() {
  ...
  return (
    <footer className="bg-footer text-footer mt-0 border-t border-[var(--color-border)]">
      <Container className="py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-[var(--color-silver-400)]">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href={ROUTES.home} className="hover:text-primary transition-colors duration-200 flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-[var(--color-primary)] opacity-50"></span>
                  דף הבית
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3 text-[var(--color-silver-400)]">
                <div className="w-8 h-8 rounded-lg bg-[var(--color-gray-300)] flex items-center justify-center shrink-0">
        ...
        {/* Bottom Bar */}
        <div className="border-footer mt-10 pt-8 text-sm text-center border-t text-[var(--color-gray-500)]">
